...
settings_base_dir = r"D:\toy\controller"
...
class ControllerSettings(object):
    ...
    def __load(self,file,validator):
    ...
    def loadPrograms(self):
        ...
        return True
    def __dump(self,file,validator,settings):
...
if __name__ == "__main__":
    master = {'invert_rain_sensor': False, 'has_rain_sensor': False, 'time_format': '%H:%M:%S', 'location': 'Garage', 'format_version': 'v1.0', 'timezone': 'SYSTEM', 'stations_wired': 6, 'controller_version': 'v1.4', 'stations_available': 8, 'date_format': '%Y-%m-%d'}